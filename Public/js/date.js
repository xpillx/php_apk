...
function fPopCalendar(evt, popCtrl, dateCtrl) {
    ...
    with ($$("calendardiv").style) {
        left = (point.x - 160 ) + "px";
        top = (point.y + popCtrl.offsetHeight + 1 - 115) + "px";
        visibility = 'visible';
        zindex = '99';
        position = 'absolute';
    }
...
function fGetXY(aTag) {
    ...
    } while (oTmp && oTmp.nodeName.toUpperCase() != "BODY");
    return pt;
}
function getDateDiv() {
    var noSelectForIE = "";
    ...
    var dateDiv = "";
    dateDiv += "<div id='calendardiv' onclick='event.cancelBubble=true' " + noSelectForIE + " style='" + noSelectForFireFox + "visibility:hidden;position:absolute;z-index:99;border:1px solid #999999;'>";
    ...
    dateDiv += "<div style=''><table width='100%' border='0' cellpadding='3' cellspacing='1'>";
